...
class BookingController extends Controller
{
    ...
    private function storeBookingOld(Request $request)
    {
        ...
        $validated = $request->validate([
            'room_type' => 'nullable|in:Self-Contained Single,Self-Contained Double,Single,Double,Twins',
    ...
    */
    ...
    public function getCorporateAvailableRooms(Request $request)
    {
        $validated = $request->validate([
            ...
            'room_types.*' => 'in:Self-Contained Single,Self-Contained Double,Single,Double,Twins',
