                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="report_type" id="report_type" class="form-control"
                                        ...
                                        <option value="daily" {{ ($reportType ?? 'monthly') == 'daily' ? 'selected' : '' }}>
                                            Daily</option>
                            ...
                            <div class="col-md-3" id="singleDateContainer">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="date" id="date" class="form-control"
                                        value="{{ $reportDate ?? today()->format('Y-m-d') }}">
                                </div>
                            </div>
                                ...
                                <div class="form-group mb-0">
                                    ...
                                    <div class="btn-group" role="group">
                                        <button type="button" class="btn btn-sm btn-outline-primary"
                                            onclick="setQuickReport('daily', '{{ today()->format('Y-m-d') }}')">
                                            <i class="fa fa-calendar-day"></i> Today
                                        </button>
                                        <button type="button" class="btn btn-sm btn-outline-primary"
                                            onclick="setQuickReport('weekly', '{{ today()->format('Y-m-d') }}')">
                                            <i class="fa fa-calendar-week"></i> This Week
                                        </button>
                                        <button type="button" class="btn btn-sm btn-outline-primary"
                                            onclick="setQuickReport('monthly', '{{ today()->format('Y-m-d') }}')">
                                            <i class="fa fa-calendar"></i> This Month
                                        </button>
                                        <button type="button" class="btn btn-sm btn-outline-primary"
                                            onclick="setQuickReport('yearly', '{{ today()->format('Y-m-d') }}')">
    ...
    @if(isset($dateRange))
        <div class="receipt-report-container">
            ...
            <div class="print-button-section">
                ...
                <div
                    style="font-size: 11px; color: #333; margin-top: 10px; background: #fff3cd; padding: 10px; border-radius: 4px; border-left: 3px solid #ffc107;">
                    <strong><i class="fa fa-info-circle"></i> Important:</strong> To remove URLs and headers from the printed
                    report:<br>
                    ...
                    <div class="receipt-info-section">
                        ...
                        <div class="receipt-info-row">
                            ...
                            <span class="receipt-info-value"
                                style="color: #007bff;"><strong>{{ $stats['total_bookings'] ?? 0 }}</strong></span>
                        </div>
                        <div class="receipt-info-row">
                            <span class="receipt-info-label">Total Rooms:</span>
                            <span class="receipt-info-value"
                                style="color: #17a2b8;"><strong>{{ $stats['total_rooms'] ?? 0 }}</strong></span>
                        </div>
                        <div class="receipt-info-row">
                            <span class="receipt-info-label">Occupancy Rate:</span>
                            <span class="receipt-info-value"
                                style="color: #28a745;"><strong>{{ $stats['occupancy_rate'] ?? 0 }}%</strong></span>
                        </div>
                        <div class="receipt-info-row">
                            <span class="receipt-info-label">Total Revenue:</span>
                            <span class="receipt-info-value"><span
                                    class="amount-highlight">{{ number_format($totalRevenueAll ?? ($stats['total_revenue'] ?? 0), 0) }}
                                    TZS</span></span>
                        </div>
                    </div>
                </div>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="text-align: right;"><strong
                                    style="color: #007bff;">{{ $operationalStats['checked_in'] ?? 0 }}</strong></td>
                        </tr>
                        <tr>
                            <td>Checked Out</td>
                            <td style="text-align: right;"><strong
                                    style="color: #dc3545;">{{ $operationalStats['checked_out'] ?? 0 }}</strong></td>
                        </tr>
                        <tr>
                            <td>New Bookings</td>
                            <td style="text-align: right;"><strong
                                    style="color: #28a745;">{{ $stats['total_bookings'] ?? 0 }}</strong></td>
                        </tr>
                        <tr>
                            <td>Confirmed Bookings</td>
                            <td style="text-align: right;"><strong
                                    style="color: #28a745;">{{ $stats['confirmed_bookings'] ?? 0 }}</strong></td>
                        </tr>
                        <tr>
                            <td>Cancelled Bookings</td>
                            <td style="text-align: right;"><strong
                                    style="color: #dc3545;">{{ $stats['cancelled_bookings'] ?? 0 }}</strong></td>
                        </tr>
                        <tr>
                            <td>Occupancy Rate</td>
                            <td style="text-align: right;"><strong
                                    style="color: #17a2b8;">{{ $stats['occupancy_rate'] ?? 0 }}%</strong></td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class="receipt-info-section">
                ...
                <table class="receipt-details-table">
                    ...
                    <tbody>
                        <tr>
                            <td>Room Bookings</td>
                            <td style="text-align: right;"><strong>{{ number_format($stats['total_revenue'] ?? 0, 0) }}
                                    TZS</strong></td>
                        </tr>
                        <tr>
                            <td>Day Services</td>
                            <td style="text-align: right;"><strong>{{ number_format($dayServicesRevenue ?? 0, 0) }} TZS</strong>
                            </td>
                        </tr>
                        <tr>
                            <td>Service Requests</td>
                            <td style="text-align: right;"><strong>{{ number_format($serviceRequests['revenue'] ?? 0, 0) }}
                                    TZS</strong></td>
                        </tr>
                        <tr class="total-row">
                            <td><strong>Total Revenue</strong></td>
                            <td style="text-align: right;"><strong
                                    style="color: #e07632; font-size: 16px;">{{ number_format($totalRevenueAll ?? ($stats['total_revenue'] ?? 0), 0) }}
                                    TZS</strong></td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div class="receipt-info-section">
                ...
                <table class="receipt-details-table">
                    ...
                    <tbody>
                        <tr>
                            <td>Swimming</td>
                            <td style="text-align: right;"><strong>{{ $dayServicesByType['swimming']['total'] ?? 0 }}</strong>
                            </td>
                            <td style="text-align: right;"><strong
                                    style="color: #28a745;">{{ $dayServicesByType['swimming']['paid'] ?? 0 }}</strong></td>
                            <td style="text-align: right;"><strong
                                    style="color: #ffc107;">{{ ($dayServicesByType['swimming']['total'] ?? 0) - ($dayServicesByType['swimming']['paid'] ?? 0) }}</strong>
                            </td>
                            <td style="text-align: right;">
                                <strong>{{ number_format($dayServicesByType['swimming']['revenue'] ?? 0, 0) }}</strong></td>
                        </tr>
                        <tr>
                            <td>Swimming with Bucket</td>
                            <td style="text-align: right;">
                                <strong>{{ $dayServicesByType['swimming_with_bucket']['total'] ?? 0 }}</strong></td>
                            <td style="text-align: right;"><strong
                                    style="color: #28a745;">{{ $dayServicesByType['swimming_with_bucket']['paid'] ?? 0 }}</strong>
                            </td>
                            <td style="text-align: right;"><strong
                                    style="color: #ffc107;">{{ ($dayServicesByType['swimming_with_bucket']['total'] ?? 0) - ($dayServicesByType['swimming_with_bucket']['paid'] ?? 0) }}</strong>
                            </td>
                            <td style="text-align: right;">
                                <strong>{{ number_format($dayServicesByType['swimming_with_bucket']['revenue'] ?? 0, 0) }}</strong>
                            </td>
                        </tr>
                        <tr>
                            <td>Ceremony</td>
                            <td style="text-align: right;"><strong>{{ $dayServicesByType['ceremony']['total'] ?? 0 }}</strong>
                            </td>
                            <td style="text-align: right;"><strong
                                    style="color: #28a745;">{{ $dayServicesByType['ceremony']['paid'] ?? 0 }}</strong></td>
                            <td style="text-align: right;"><strong
                                    style="color: #ffc107;">{{ ($dayServicesByType['ceremony']['total'] ?? 0) - ($dayServicesByType['ceremony']['paid'] ?? 0) }}</strong>
                            </td>
                            <td style="text-align: right;">
                                <strong>{{ number_format($dayServicesByType['ceremony']['revenue'] ?? 0, 0) }}</strong></td>
                        </tr>
                        <tr class="total-row">
                            <td><strong>Total Day Services</strong></td>
                            <td style="text-align: right;"><strong>{{ $dayServicesStats['total'] ?? 0 }}</strong></td>
                            <td style="text-align: right;"><strong
                                    style="color: #28a745;">{{ $dayServicesStats['paid'] ?? 0 }}</strong></td>
                            <td style="text-align: right;"><strong
                                    style="color: #ffc107;">{{ $dayServicesStats['pending'] ?? 0 }}</strong></td>
                            <td style="text-align: right;"><strong
                                    style="color: #e07632; font-size: 14px;">{{ number_format($dayServicesRevenue ?? 0, 0) }}
                                    TZS</strong></td>
                        </tr>
                    </tbody>
                </table>
                ...
                <table class="receipt-details-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>Pending</td>
                            <td style="text-align: right;"><strong
                                    style="color: #ffc107;">{{ $serviceRequests['pending'] ?? 0 }}</strong></td>
                        </tr>
                        <tr>
                            <td>Approved</td>
                            <td style="text-align: right;"><strong
                                    style="color: #17a2b8;">{{ $serviceRequests['approved'] ?? 0 }}</strong></td>
                        </tr>
                        <tr>
                            <td>Completed</td>
                            <td style="text-align: right;"><strong
                                    style="color: #28a745;">{{ $serviceRequests['completed'] ?? 0 }}</strong></td>
                        </tr>
                        <tr class="total-row">
                ...
                <table class="receipt-details-table">
                    ...
                    <tbody>
                        ...
                        <tr class="total-row">
                            ...
                            <td style="text-align: right;"><strong
                                    style="color: #28a745;">{{ $ceremonyPaid + $walkInPaid }}</strong></td>
                            <td style="text-align: right;"><strong
                                    style="color: #dc3545;">{{ $ceremonyUnpaid + $walkInUnpaid }}</strong></td>
                            <td style="text-align: right;"><strong
                                    style="color: #e07632; font-size: 14px;">{{ number_format($totalConsumptionRevenue, 0) }}
                                    TZS</strong></td>
                        </tr>
                    </tbody>
                </table>
                ...
                <div class="receipt-two-column">
                    <div class="receipt-column">
                        <div class="receipt-info-row">
                            ...
                            <span class="receipt-info-value"
                                style="color: #ffc107;"><strong>{{ $stats['month_bookings'] ?? 0 }}</strong></span>
                        </div>
                        <div class="receipt-info-row">
                            <span class="receipt-info-label">Last Month Bookings:</span>
                            <span class="receipt-info-value"
                                style="color: #666;">{{ $stats['last_month_bookings'] ?? 0 }}</span>
                        </div>
                    </div>
                    <div class="receipt-column">
                        <div class="receipt-info-row">
                            ...
                            <span class="receipt-info-value"
                                style="color: #e07632;"><strong>{{ number_format($stats['month_revenue'] ?? 0, 0) }}
                                    TZS</strong></span>
                        </div>
                        <div class="receipt-info-row">
                            <span class="receipt-info-label">Last Month Revenue:</span>
                            <span class="receipt-info-value"
                                style="color: #666;">{{ number_format($stats['last_month_revenue'] ?? 0, 0) }} TZS</span>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <tbody>
                            @foreach($topRooms as $index => $roomData)
                                <tr>
                                    ...
                                    <td style="text-align: right;"><strong>{{ number_format($roomData->total_revenue ?? 0, 0) }}
                                            TZS</strong></td>
                                </tr>
                            @endforeach
                        </tbody>
