...
<div class="row mb-3">
  <div class="col-md-12">
    <div class="tile">
      ...
      <div class="tile-body">
        <!-- Filters -->
        <form method="GET" action="{{ route('admin.issues.index') }}" class="mb-3">
          <div class="row">
            <div class="col-md-3">
            ...
            <div class="col-md-4">
              <input type="text" name="search" class="form-control" placeholder="Search by subject, description, or guest name..." value="{{ request('search') }}">
            </div>
            <div class="col-md-2">
        ...
        <div class="table-responsive">
          <table class="table table-hover table-bordered">
            ...
            <tbody>
              ...
              <tr class="{{ $issue->priority === 'urgent' && $issue->status !== 'resolved' ? 'table-danger' : '' }}">
                ...
                <td>
                  <div class="btn-group" role="group">
                    ...
                    @endif
                    <a href="{{ route('admin.issues.show', $issue) }}" class="btn btn-sm btn-info" title="View Details">
