  ...
  <div class="app-title">
    ...
    <ul class="app-breadcrumb breadcrumb">
      ...
      <li class="breadcrumb-item"><a
          href="{{ $role === 'manager' ? route('admin.dashboard') : route('reception.dashboard') }}">Dashboard</a></li>
  ...
  <div class="row mb-3">
    <div class="col-md-12">
      <div class="tile">
        ...
        <div class="tile-body">
          <form method="GET"
            action="{{ $role === 'manager' ? route('admin.reports.daily') : route('reception.reports') }}"
            id="reportForm">
            <div class="row">
              <div class="col-md-3">
  ...
  @if(isset($dateRange))
    ...
    <div class="receipt-report-container">
      ...
      <div class="receipt-report-number">
        ...
        OPR-RPT-{{ date('Ymd') }}-{{ strtoupper(substr(md5($dateRange['label'] . now()), 0, 6)) }}
      </div>
          ...
          <div class="receipt-info-section">
            ...
            <div class="receipt-info-row">
              ...
              <span class="receipt-info-value"
                style="color: #007bff;"><strong>{{ $bookings['checked_in'] ?? 0 }}</strong></span>
            </div>
            <div class="receipt-info-row">
              <span class="receipt-info-label">Checked Out:</span>
              <span class="receipt-info-value"
                style="color: #dc3545;"><strong>{{ $bookings['checked_out'] ?? 0 }}</strong></span>
            </div>
            <div class="receipt-info-row">
              <span class="receipt-info-label">New Bookings:</span>
              <span class="receipt-info-value"
                style="color: #28a745;"><strong>{{ $bookings['new_bookings'] ?? 0 }}</strong></span>
            </div>
            <div class="receipt-info-row">
      ...
      <div class="receipt-info-section">
        ...
        <table class="receipt-details-table">
          ...
          <tbody>
            ...
            <tr>
              <td>Pending</td>
              <td style="text-align: right;"><strong style="color: #ffc107;">{{ $serviceRequests['pending'] ?? 0 }}</strong>
              </td>
            </tr>
            <tr>
              <td>Approved</td>
