  ...
  <div class="app-title">
    ...
    <ul class="app-breadcrumb breadcrumb">
      ...
      <li class="breadcrumb-item"><a
          href="{{ isset($role) && $role === 'super_admin' ? route('super_admin.dashboard') : route('admin.dashboard') }}">Dashboard</a>
      </li>
      ...
      <div class="tile">
        ...
        <form id="roomForm" method="POST"
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" id="room_number" name="room_number"
                    placeholder="e.g., 101, Deluxe Suite" value="{{ $room->room_number ?? '' }}" required>
                  <small class="form-text text-muted" id="room_number_help_text">Enter a unique room number or
                    name</small>
                </div>
              </div>
            </div>
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group mb-3">
                        <div class="form-check">
                          <input class="form-check-input" type="checkbox" id="enable_bulk_create" name="enable_bulk_create"
                            value="1">
                      ...
                      <div class="row mb-3" id="quantity_section" style="display: none;">
                        <div class="col-md-6">
                          <div class="form-group">
                            <label for="bulk_quantity" id="bulk_quantity_label">How many rooms? <span
                                class="text-danger">*</span></label>
                            <input class="form-control" type="number" id="bulk_quantity" name="bulk_quantity" min="2"
                              max="50" value="2" placeholder="e.g., 3 or 4">
                            <small class="form-text text-muted">Enter the number of rooms you want to create (minimum
                              2)</small>
                          </div>
                        </div>
                      </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="btn-group btn-group-toggle" data-toggle="buttons" style="width: 100%;">
                              <label class="btn btn-outline-primary" style="flex: 1;">
                                <input type="radio" name="assignment_method" id="auto_generate" value="auto"
                                  autocomplete="off">
                                <i class="fa fa-magic"></i> Auto-Generate (Sequential)
                              </label>
                              <label class="btn btn-outline-primary active" style="flex: 1;">
                                <input type="radio" name="assignment_method" id="manual_assign" value="manual" checked
                                  autocomplete="off">
                                <i class="fa fa-edit"></i> Manual Assignment
                              </label>
                            </div>
                            <small class="form-text text-muted mt-2">Choose how room numbers will be assigned.
                              <strong>Manual</strong> allows non-sequential numbers (e.g., 100, 204, 4046)</small>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row mb-3" id="auto_generate_section" style="display: none;">
                        <div class="col-md-6">
                          <div class="form-group">
                            <label for="starting_room_number">Starting Room Number <span
                                class="text-danger">*</span></label>
                            <input class="form-control" type="text" id="starting_room_number" name="starting_room_number"
                              placeholder="e.g., 201" value="">
                            <small class="form-text text-muted">System will create sequential room numbers starting from
                              this number. Existing room numbers will be automatically skipped.</small>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group">
                      ...
                      <div class="row mb-3" id="manual_assign_section" style="display: block;">
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input class="form-control" type="text" id="manual_room_numbers" name="manual_room_numbers"
                              placeholder="e.g., 100, 204, 4046 or 201, 203, 205" value="">
                            <small class="form-text text-muted">Enter room numbers separated by commas. Can be
                              non-sequential (e.g., 100, 204, 4046). Existing room numbers will be automatically
                              skipped.</small>
                          </div>
                        </div>
                        <div class="col-md-6">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="form-control" type="number" id="capacity" name="capacity" min="1" max="10"
                    placeholder="Maximum number of guests" value="{{ $room->capacity ?? '' }}" required>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <select class="form-control" id="bed_type" name="bed_type" required>
                    ...
                    <option value="Queen" {{ (isset($room) && $room->bed_type == 'Queen') ? 'selected' : '' }}>Queen
                    </option>
                    ...
                    <option value="Single" {{ (isset($room) && $room->bed_type == 'Single') ? 'selected' : '' }}>Single
                    </option>
                  </select>
                </div>
              </div>
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="description" name="description" rows="4"
                    placeholder="Short description of the room, amenities, or view">{{ $room->description ?? '' }}</textarea>
                </div>
              </div>
            </div>
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input class="form-control" type="number" id="price_per_night" name="price_per_night" min="0"
                      placeholder="0" value="{{ $room->price_per_night ?? '' }}" required>
                  </div>
          ...
          <div class="wizard-step" data-step="3" style="display: none;">
            ...
            <div class="mb-3">
              <button type="button" class="btn btn-sm btn-outline-primary" id="checkAllAmenities"
                onclick="toggleAllAmenities()">
                <i class="fa fa-check-square"></i> Check All
              </button>
              <button type="button" class="btn btn-sm btn-outline-secondary" id="uncheckAllAmenities"
                onclick="toggleAllAmenities(false)" style="display: none;">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label class="checkbox-inline">
                    <input type="checkbox" id="wifi" name="amenities[]" value="Free Wi-Fi" class="amenity-checkbox"> <i
                      class="fa fa-wifi"></i> Free Wi-Fi
                  </label>
                </div>
                <div class="form-group">
                  <label class="checkbox-inline">
                    <input type="checkbox" id="ac_heating" name="amenities[]" value="Air-Conditioning"
                      class="amenity-checkbox"> <i class="fa fa-thermometer-half"></i> Air-Conditioning
                  </label>
                </div>
                <div class="form-group">
                  <label class="checkbox-inline">
                    <input type="checkbox" id="tv" name="amenities[]" value="Smart TV Screen" class="amenity-checkbox"> <i
                      class="fa fa-tv"></i> Smart TV Screen
                  </label>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <label class="checkbox-inline">
                    <input type="checkbox" id="telephone" name="amenities[]" value="Telephone extension"
                      class="amenity-checkbox"> <i class="fa fa-phone"></i> Telephone extension
                  </label>
                </div>
                <div class="form-group">
                  <label class="checkbox-inline">
                    <input type="checkbox" id="tea_coffee" name="amenities[]" value="Tea and Coffee facility"
                      class="amenity-checkbox"> <i class="fa fa-coffee"></i> Tea and Coffee facility
                  </label>
                </div>
                <div class="form-group">
                  <label class="checkbox-inline">
                    <input type="checkbox" id="hair_dryer" name="amenities[]" value="Hair dryer" class="amenity-checkbox">
                    <i class="fa fa-fan"></i> Hair dryer
                  </label>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="form-control" type="time" id="checkin_time" name="checkin_time"
                    value="{{ isset($room) && $room->checkin_time ? substr($room->checkin_time, 0, 5) : '14:00' }}">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="form-control" type="time" id="checkout_time" name="checkout_time"
                    value="{{ isset($room) && $room->checkout_time ? substr($room->checkout_time, 0, 5) : '10:00' }}">
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" id="special_notes" name="special_notes" rows="3"
                placeholder="e.g., pet-friendly, smoking allowed, special requests"></textarea>
            </div>

            <div class="form-group">
              <label for="wifi_password">WiFi Password</label>
              <input class="form-control" type="text" id="wifi_password" name="wifi_password"
                placeholder="e.g., Umoj Lutheran Hostel2024" maxlength="255">
            ...
            <div class="preview-container">
              <div class="preview-section">
                ...
                <table class="table table-bordered">
                  <tr>
                    <th width="30%">Room Number/Name:</th>
                    <td id="preview_room_number">-</td>
                  </tr>
                  <tr>
                    <th>Room Type:</th>
                    <td id="preview_room_type">-</td>
                  </tr>
                  <tr>
                    <th>Capacity:</th>
                    <td id="preview_capacity">-</td>
                  </tr>
                  <tr>
                    <th>Bed Type:</th>
                    <td id="preview_bed_type">-</td>
                  </tr>
                  <tr>
                    <th>Description:</th>
                    <td id="preview_description" style="white-space: pre-wrap; word-wrap: break-word;">-</td>
                  </tr>
                </table>
              </div>
              ...
              <div class="preview-section mt-4">
                ...
                <table class="table table-bordered">
                  <tr>
                    <th width="30%">Price per Night:</th>
                    <td id="preview_price_per_night">-</td>
                  </tr>
                </table>
              </div>
              ...
              <div class="preview-section mt-4">
                ...
                <table class="table table-bordered">
                  <tr>
                    ...
                    <td id="preview_checkin_time">-</td>
                  </tr>
                  <tr>
                    <th>Check-out Time:</th>
                    <td id="preview_checkout_time">-</td>
                  </tr>
                  <tr>
                    <th>Special Notes:</th>
                    <td id="preview_special_notes" style="white-space: pre-wrap; word-wrap: break-word;">-</td>
                  </tr>
                </table>
              </div>
...
@section('scripts')
  ...
  <style>
    ...
    @media (max-width: 768px) {
      ...
      select.form-control {
        font-size: 16px !important;
        /* Prevents zoom on iOS and ensures visibility */
