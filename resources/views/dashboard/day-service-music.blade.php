...
@section('content')
    <div class="app-title">
        <div>
            <h1><i class="fa fa-music"></i> Music & Sound System Registration</h1>
            <p>Register music and sound system services for guests</p>
        </div>
                    ...
                    <form id="musicForm" method="POST"
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" id="purpose" name="purpose"
                                        placeholder="e.g., party, presentation">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="notes" name="notes" rows="2"
                                placeholder="Any additional equipment, microphones etc..."></textarea>
                        </div>
    ...
    <script>
        ...
        function calculateAmount() {
            if (!numberPeopleInput) {
                ...
                priceTanzanian = {{ $musicService->price_tanzanian }};
                pricingType = '{{ $musicService->pricing_type }}';
            }
