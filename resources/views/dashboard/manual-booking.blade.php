...
@section('content')
  <div class="app-title">
    ...
    <ul class="app-breadcrumb breadcrumb">
      ...
      <li class="breadcrumb-item"><a
          href="{{ $role === 'reception' ? route('reception.bookings') : route('admin.bookings.index') }}">Bookings</a>
      </li>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="tile">
        ...
        <form id="manualBookingForm" method="POST"
          action="{{ $role === 'reception' ? route('reception.bookings.manual.store') : route('admin.bookings.manual.store') }}">
          @csrf
          ...
          <div class="wizard-step" data-step="1">
            ...
            <div class="row mb-4">
              <div class="col-md-12">
                <div class="guest-search-box shadow-sm mb-2"
                  style="background: white; border-radius: 12px; padding: 20px; border: 1px solid #e0e0e0; transition: all 0.3s ease;">
                  <div class="search-header d-flex align-items-center mb-3">
                    <div class="search-icon-circle mr-3"
                      style="width: 45px; height: 45px; background: #e0f2f1; color: #009688; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 20px;">
                      <i class="fa fa-user-circle-o"></i>
                    </div>
                    <div>
                      <h6 class="mb-0 font-weight-bold text-dark"
                        style="text-transform: uppercase; letter-spacing: 0.5px;">RETURNING GUEST?</h6>
                      <small class="text-muted">Search by name, email or phone to auto-fill details from existing
                        records</small>
                    </div>
                  </div>
                    ...
                    <div class="input-group search-input-group">
                      <div class="input-group-prepend">
                        <span class="input-group-text bg-white border-right-0"
                          style="border-radius: 8px 0 0 8px; color: #009688;"><i class="fa fa-search"
                            id="guestSearchIcon"></i></span>
                      </div>
                      <input type="text" id="guestSearchInput" class="form-control border-left-0"
                        style="height: 48px; font-size: 16px; border-radius: 0 8px 8px 0;"
                        placeholder="Start typing guest name, email or phone number..." autocomplete="off">
                    </div>
                    <div id="guestSearchResults" class="list-group position-absolute w-100 mt-2 shadow-lg"
                      style="display: none; z-index: 1100; max-height: 300px; overflow-y: auto; border-radius: 10px; border: 1px solid #eee;">
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" id="full_name" name="full_name" placeholder="Guest full name"
                    required>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <div class="input-group-prepend">
                      <span class="input-group-text" id="phone_country_code"
                        style="min-width: 60px; text-align: center;">+255</span>
                    </div>
                    <input class="form-control" type="text" id="guest_phone" name="guest_phone"
                      placeholder="Phone number (without country code)" required>
                  </div>
                  <small class="form-text text-muted">Country code will be auto-filled based on nationality
                    selection</small>
                </div>
              </div>
              <div class="col-md-6">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="form-control" type="number" id="number_of_guests" name="number_of_guests" min="1" max="10"
                    value="1" required>
            ...
            <div class="row">
              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <input class="form-control" type="time" id="check_out_time" name="check_out_time" value="10:00"
                    required>
                </div>
              </div>
            </div>
            ...
            <div class="row mt-3" id="available_rooms_container" style="display: none;">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <small class="form-text text-muted d-block mb-3" id="room_select_hint">Please select room type, check-in
                    and check-out dates to see available rooms</small>
                    ...
                    <div class="card" style="border-radius: 10px; border: 1px solid #e0e0e0; background-color: #fcfcfc;">
                      <div class="card-body p-3">
                        <h6 class="mb-3 text-muted"
                          style="font-size: 13px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;">
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="special_requests" name="special_requests" rows="3"
                    placeholder="Any special requests or notes about this booking"></textarea>
                  <small class="form-text text-muted">Select departments below to notify them about these special
                    requests</small>
                </div>
              </div>
            </div>
              ...
              <div class="col-md-12">
                <div class="form-group">
                  <label class="d-flex align-items-center">
                    ...
                    Notify Departments
                    <small class="text-muted ml-2">(Optional - Select departments to notify about special
                      requests)</small>
                  </label>

                  <div class="alert alert-info mb-3" style="background-color: #e7f3ff; border-left: 4px solid #2196F3;">
                    <i class="fa fa-info-circle"></i>
                    <strong>How it works:</strong> When you select departments below, they will receive a notification
                    with the guest's special requests/notes. This helps coordinate guest needs across different
                    departments.
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-4 mb-3">
                      <div class="card department-card"
                        style="border: 2px solid #e0e0e0; border-radius: 8px; transition: all 0.3s; cursor: pointer;"
                        onclick="toggleDepartment('notify_reception')">
                        <div class="card-body text-center p-3">
                          <input class="form-check-input department-checkbox" type="checkbox" id="notify_reception"
                            name="notify_departments[]" value="reception"
                            style="position: absolute; top: 10px; right: 10px; transform: scale(1.3);"
                          ...
                          <div class="mt-2">
                            <span class="badge badge-primary badge-sm" id="reception-badge"
                    ...
                    <div class="col-md-4 mb-3">
                      <div class="card department-card"
                        style="border: 2px solid #e0e0e0; border-radius: 8px; transition: all 0.3s; cursor: pointer;"
                        onclick="toggleDepartment('notify_bar')">
                        <div class="card-body text-center p-3">
                          <input class="form-check-input department-checkbox" type="checkbox" id="notify_bar"
                            name="notify_departments[]" value="bar_keeper"
                            style="position: absolute; top: 10px; right: 10px; transform: scale(1.3);"
                            onchange="updateDepartmentCard(this)">
                          <div class="mb-2">
                          ...
                          <div class="mt-2">
                            <span class="badge badge-warning badge-sm" id="bar-badge"
                              style="display: none;">Selected</span>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="col-md-4 mb-3">
                      <div class="card department-card"
                        style="border: 2px solid #e0e0e0; border-radius: 8px; transition: all 0.3s; cursor: pointer;"
                        onclick="toggleDepartment('notify_kitchen')">
                        <div class="card-body text-center p-3">
                          <input class="form-check-input department-checkbox" type="checkbox" id="notify_kitchen"
                            name="notify_departments[]" value="head_chef"
                            style="position: absolute; top: 10px; right: 10px; transform: scale(1.3);"
                            onchange="updateDepartmentCard(this)">
                          <div class="mb-2">
                          ...
                          <div class="mt-2">
                            <span class="badge badge-danger badge-sm" id="kitchen-badge"
                              style="display: none;">Selected</span>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="mt-3" id="department-preview" style="display: none;">
                    <div class="alert alert-success">
                      ...
                      <span id="preview-text">Selected departments will receive a notification with the guest's special
                        requests.</span>
                    </div>
                  </div>
                </div>
          ...
          <div class="wizard-step" data-step="3" style="display: none;">
            ...
            <div class="alert alert-info" id="calculationHint" style="display: none;">
              <i class="fa fa-info-circle"></i> <strong>Note:</strong> Please select a room and set check-in/check-out
              dates to see the recommended price.
            </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input class="form-control" type="number" id="recommended_price" placeholder="0" readonly
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input class="form-control" type="number" id="total_price" name="total_price" min="0" placeholder="0"
                      required>
                  </div>
                  <small class="form-text text-muted">Enter total price (can be lower than recommended for
                    discounts)</small>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input class="form-control" type="number" id="amount_paid" name="amount_paid" min="0" placeholder="0"
                      required>
                  </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <input class="form-control" type="number" id="payment_percentage" name="payment_percentage"
                      step="0.01" min="0" max="100" placeholder="0.00" readonly style="background-color: #f8f9fa;">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input class="form-control" type="number" id="remaining_amount" name="remaining_amount" min="0"
          ...
          <div class="wizard-step" data-step="4" style="display: none;">
            ...
            <div class="alert alert-info mb-4">
              <strong><i class="fa fa-info-circle"></i> Note:</strong> After creating this booking, the guest will receive
              an email and SMS with:
              <ul class="mb-0 mt-2">
            ...
            <div class="wizard-navigation mt-4 pt-3 border-top">
              ...
              <a class="btn btn-secondary mr-2"
                href="{{ $role === 'reception' ? route('reception.bookings') : route('admin.bookings.index') }}">
  ...
  <script>
    ...
    function validateWizardStep(step) {
      if (step === 1) {
        ...
        if (paymentMethod !== 'pay_later' && (!amountPaid || parseFloat(amountPaid) <= 0)) {
    ...
    document.addEventListener('DOMContentLoaded', function () {
      ...
      if (typeof jQuery !== 'undefined' && typeof jQuery.fn.select2 !== 'undefined') {
        jQuery(document).ready(function ($) {
          ...
          $('#room_type').select2({
            placeholder: 'Search and select room type...',
            allowClear: false,
            width: '100%'
          });
      ...
      // Set minimum date to yesterday to allow early morning check-ins
      const yesterdayDate = new Date();
      yesterdayDate.setDate(yesterdayDate.getDate() - 1);
      const yesterday = yesterdayDate.toISOString().split('T')[0];

      checkInInput.setAttribute('min', yesterday);
      checkOutInput.setAttribute('min', yesterday);
      ...
      const roomTypeCapacities = {!! json_encode($roomTypeCapacities ?? [
    'Self-Contained Single' => 1,
    'Self-Contained Double' => 2,
    'Standard Single' => 1,
    'Standard Double' => 2,
    'Standard Triple' => 3,
    'Standard Decker' => 4,
    ...
    'Twins' => 2,
          ...
          .then(data => {
            ...
            if (data.success) {
              ...
              if (summaryContainer && summaryPills) {
                ...
                // Order types: Categorical order
                const typesOrder = [
                  'Self-Contained Single', 'Self-Contained Double',
                  'Standard Single', 'Standard Double', 'Standard Triple', 'Standard Decker',
                  'En-suite Single', 'En-suite Triple', 'En-suite Quad', 'En-suite Quint',
                  'Single', 'Double', 'Twins'
                ];
                ...
                sortedTypes.forEach(type => {
                  ...
                  pill.onclick = function () {
                    if (!isSelectedType) {
                      if (typeof jQuery !== 'undefined' && typeof jQuery.fn.select2 !== 'undefined') {
                        jQuery('#room_type').val(type).trigger('change');
                      } else {
      ...
      function createRoomCard(room) {
        ...
        card.className = 'room-card compact-card' + (canSelect ? '' : ' unselectable');
        card.style.cursor = canSelect ? 'pointer' : 'not-allowed';
        ...
        card.setAttribute('data-room-extra-fee', room.extra_guest_fee || 0);
        card.setAttribute('data-room-capacity', room.capacity || 1);
        card.setAttribute('data-can-select', canSelect);

        let cardHtml = '<div class="d-flex justify-content-between align-items-start mb-2">';
        cardHtml += '  <div class="font-weight-bold" style="font-size: 16px;"><i class="fa fa-home mr-1 text-muted"></i>#' + room.room_number + '</div>';
        cardHtml += '  <span class="badge ' + badgeClass + '" style="font-size: 10px;">' + badgeText + '</span>';
        cardHtml += '</div>';

        cardHtml += '<div class="text-muted mb-2" style="font-size: 12px;">';
        cardHtml += '  <i class="fa fa-bed mr-1"></i> ' + room.room_type;
...
<div class="modal fade" id="lastBookingModal" tabindex="-1" role="dialog" aria-hidden="true" style="z-index: 9999;">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content"
      style="border-radius: 15px; border: none; overflow: hidden; box-shadow: 0 15px 35px rgba(0,0,0,0.2);">
