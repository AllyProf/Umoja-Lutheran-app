                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" type="number" step="0.01" id="amount" name="amount"
                                                value="{{ number_format($projectorService->price_tanzanian, 0, '.', '') }}"
                                                min="0" required>
                                        </div>
                                        <small class="form-text text-info">
                                            <i class="fa fa-info-circle"></i> Recommended:
                                            <span
                                                id="recommended_amount_tzs">{{ number_format($projectorService->price_tanzanian, 0) }}
                                                TSh</span>
                                ...
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                            ...
                                            <input class="form-control" type="number" step="0.01" id="amount_paid"
                                                name="amount_paid"
                                                value="{{ number_format($projectorService->price_tanzanian, 0, '.', '') }}" min="0"
                                                required>
                                </div>
                            </div>
