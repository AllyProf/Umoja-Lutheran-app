      ...
      <div class="tile">
        ...
        <div class="row mb-3">
          <div class="col-md-12">
            <div class="btn-group" role="group">
              ...
              <a href="{{ route('bar-keeper.transfers.index', ['status' => 'pending']) }}"
                class="btn {{ request('status') == 'pending' ? 'btn-primary' : 'btn-outline-primary' }}">Pending</a>
              <a href="{{ route('bar-keeper.transfers.index', ['status' => 'completed']) }}"
                class="btn {{ request('status') == 'completed' ? 'btn-primary' : 'btn-outline-primary' }}">Completed</a>
            </div>
          </div>
        </div>
              ...
              <tbody>
                @foreach($transfers as $transfer)
                  <tr>
                    ...
                    <td>{{ $transfer->productVariant->measurement ?? 'N/A' }}
                      ({{ $transfer->productVariant->packaging ?? 'N/A' }})</td>
                    <td>
        ...
        @else
          <div class="text-center" style="padding: 50px;">
            ...
            <a href="{{ route('bar-keeper.transfers.index') }}" class="btn btn-outline-secondary btn-sm mt-3">View All
              Transfers</a>
          </div>
        @endif
      </div>
