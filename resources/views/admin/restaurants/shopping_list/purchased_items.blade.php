                    ...
                    <form method="GET" action="{{ route('admin.restaurants.shopping-list.purchased-items') }}" class="row">
                                    ...
                                    @if(isset($allShoppingListsForFilter))
                                        @foreach($allShoppingListsForFilter as $list)
                                            <option value="{{ $list->id }}" {{ request('shopping_list_id') == $list->id ? 'selected' : '' }}>
                                                {{ $list->name }}
                                                ({{ $list->shopping_date ? $list->shopping_date->format('d M Y') : 'N/A' }})
                                            </option>
                                        @endforeach
                                    @endif
                                </select>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <a href="{{ route('admin.restaurants.shopping-list.purchased-items') }}"
                                    class="btn btn-secondary"><i class="fa fa-refresh"></i> Reset</a>
                            </div>
                        </div>
                    </form>
                </div>
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            <tbody>
                                @forelse($shoppingLists as $list)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <a href="{{ route('admin.restaurants.shopping-list.receiving-report', $list->id) }}"
                                                    target="_blank" class="btn btn-sm btn-primary"
                                                    title="Print Receiving Report">
                                                    <i class="fa fa-print"></i> Print
                                                </a>
                                                <a href="{{ route('admin.restaurants.shopping-list.download', $list->id) }}"
                                    ...
                                    <tr>
                                        <td colspan="9" class="text-center">
                                            <div class="alert alert-info">
                                                <i class="fa fa-info-circle"></i> <strong>No purchased shopping lists
                                                    found.</strong>
                                                <br><br>
                                                <p class="mb-0">
                                                    ...
                                                    <br>
                                                    Go to <a
                                                        href="{{ route('admin.restaurants.shopping-list.index') }}">Shopping
                                                        Lists</a> and click "Receive" to record purchases.
                                                </p>
                                            </div>
                                        </td>
                                    </tr>
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td><strong>{{ number_format($shoppingLists->sum(function ($list) {
        return $list->items->where('is_purchased', true)->where('is_found', true)->sum('purchased_cost'); }), 2) }}
                                            TZS</strong></td>
                                    <td colspan="4"></td>
                                </tr>
                            </tfoot>
