...
<head>
    ...
    <style>
        ...
        .date-wrapper .date-input {
            ...
            color: #fff0;
            /* Hide built-in date placeholder - transparent hex */
            display: block !important;
        ...
        .date-wrapper .date-input:valid {
            ...
            /* Show typed date when focused or valid */
            border-color: #e77a3a !important;
...
<body>
    ...
    <section class="banner_area">
        <div class="booking_table d_flex align-items-center">
            <div class="overlay bg-parallax bg-image-1 active" data-stellar-ratio="0.9" data-stellar-vertical-offset="0"
                data-background=""></div>
            <div class="overlay bg-parallax bg-image-2" data-stellar-ratio="0.9" data-stellar-vertical-offset="0"
                data-background=""></div>
            <div class="overlay bg-parallax bg-image-3" data-stellar-ratio="0.9" data-stellar-vertical-offset="0"
                data-background=""></div>
            <div class="overlay bg-parallax bg-image-4" data-stellar-ratio="0.9" data-stellar-vertical-offset="0"
                data-background=""></div>
            <div class="overlay bg-parallax bg-image-5" data-stellar-ratio="0.9" data-stellar-vertical-offset="0"
                data-background=""></div>
            <div class="container">
                <div class="banner_content text-center">
                    <h2 style="color: #e77a3a;">Welcome to {{ config('app.name') }}</h2>
                    <h4>Comfort in every stay.</h4>
                    <a href="{{ route('booking.index') }}" class="btn theme_btn button_hover"
                        style="margin-top: 20px;">Book Now</a>
                </div>
            </div>
        </div>
                        ...
                        <div class="boking_table">
                            <form id="availabilityForm" action="{{ route('booking.index') }}" method="GET">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="book_tabel_item">
                                            <div class="form-group date-wrapper">
                                                <input type="date" class="form-control date-input" name="check_in"
                                                    id="check_in" required inputmode="none" min="{{ date('Y-m-d') }}"
                                                    value="{{ isset($initial_check_in) ? date('Y-m-d', strtotime($initial_check_in)) : '' }}">
                                                <span class="placeholder-text">Arrival Date</span>
                                            </div>
                                            <div class="form-group date-wrapper">
                                                <input type="date" class="form-control date-input" name="check_out"
                                                    id="check_out" required inputmode="none" min="{{ date('Y-m-d') }}"
                                        ...
                                        <div class="book_tabel_item">
                                            <div class="input-group">
                                                <select class="wide" name="room_type" id="room_type">
                                                    ...
                                                    <option value="Twins" {{ isset($initial_room_type) && $initial_room_type == 'Twins' ? 'selected' : '' }}>Standard Twin
                                                        Room</option>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="book_tabel_item">
                                            <button type="submit" class="book_now_btn button_hover">Check
                                                Availability</button>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="container">
            <div class="section_title text-center">
                <h2 class="title_color"
                    style="color: #e77a3a; font-size: 36px; margin-bottom: 15px; position: relative; display: inline-block; padding-bottom: 15px;">
                    Available Rooms
                    <span
                        style="position: absolute; bottom: 0; left: 50%; transform: translateX(-50%); width: 60px; height: 3px; background: #e77a3a; border-radius: 2px;"></span>
                </h2>
                <p style="font-size: 16px; color: #777; margin-top: 20px;">Choose from our comfortable and
                    well-appointed rooms designed for your perfect stay</p>
            </div>
            <div class="row mb_30">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="accomodation_item text-center">
                        ...
                        <a href="{{ route('booking.index') }}">
                            <h4 class="sec_h4">Standard Twin Room</h4>
                        </a>
            ...
            <div class="row">
                <div class="col-md-6 d_flex align-items-center">
                    <div class="about_content">
                        ...
                        <p>Located along Sokoine road 1.5km from Moshi Town center; Our hotel makes a convenient place
                            for your stay. Whether you are a business traveler, adventure seeker, or visiting family and
                            friends, our location makes a perfect spot for your stay with nearest proximity to the town
                            center and its important amenities. Public transport is easily accessible to and from town
                            center. The connection of tarmac road makes it easier to commute with any type of
                            automotive.</p>
                            ...
                            <ul style="list-style: none; padding: 0;">
                                <li style="margin-bottom: 15px; padding-left: 25px; position: relative;">
                                    <i class="lnr lnr-map-marker"
                                        style="position: absolute; left: 0; color: #e77a3a; font-size: 18px;"></i>
                                    <strong style="color: #222222;">1.5km</strong> approximately <strong
                                        style="color: #222222;">7 minutes' drive</strong> to Moshi town center
                                </li>
                                <li style="margin-bottom: 15px; padding-left: 25px; position: relative;">
                                    <i class="lnr lnr-map-marker"
                                        style="position: absolute; left: 0; color: #e77a3a; font-size: 18px;"></i>
                                    <strong style="color: #222222;">45 minutes' drive</strong> to Kilimanjaro
                ...
                <div class="col-md-6">
                    ...
                    <div class="video_wrapper"
                        style="position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; border-radius: 10px; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.15); margin-top: 30px;">
                        <video
    ...
    <section class="testimonial_area section_gap" style="position: relative; overflow: hidden; padding: 80px 0;">
        ...
        <div class="container" style="position: relative; z-index: 2;">
            <div class="section_title text-center" style="margin-bottom: 50px;">
                <h2 class="title_color"
                    style="color: #fff; font-size: 36px; font-weight: 700; margin-bottom: 10px; text-transform: uppercase; letter-spacing: 1px;">
                    Our Clients Reviews</h2>
                <p
                    style="color: rgba(255,255,255,0.8); font-size: 16px; margin: 0; max-width: 600px; margin-left: auto; margin-right: auto;">
                    Hear what our guests have to say</p>
            </div>
            <div class="testimonial_slider owl-carousel" id="testimonialCarousel">
                ...
                <div class="testimonial_card_item box_shadow_hover">
                    ...
                    <div class="testimonial_card_details">
                        ...
                        <div class="testimonial_card_text_content">
                            <p>"The staff are helpful and understanding. The hotel is very clean. The space is
                                beautiful..."</p>
                            <button class="read_more_btn" data-author="Serah"
                                data-avatar="https://flagcdn.com/w160/ke.png" data-location="Kenya"
                ...
                <div class="testimonial_card_item box_shadow_hover">
                    ...
                    <div class="testimonial_card_details">
                        ...
                        <div class="testimonial_card_text_content">
                            <p>"The staff from the gate, to the reception to the kitchen and the servers are just but
                                amaazzzing..."</p>
                            <button class="read_more_btn" data-author="Sharon Jeruto"
                                data-avatar="https://flagcdn.com/w160/ke.png" data-location="Kenya"
                ...
                <div class="testimonial_card_item box_shadow_hover">
                    ...
                    <div class="testimonial_card_details">
                        ...
                        <div class="testimonial_card_text_content">
                            <p>"The best food in Moshi. We liked it here. Very friendly staff, clean rooms, low prices
                                for food..."</p>
                            <button class="read_more_btn" data-author="Arina"
                                data-avatar="https://flagcdn.com/w160/md.png" data-location="Moldova"
                ...
                <div class="testimonial_card_item box_shadow_hover">
                    ...
                    <div class="testimonial_card_details">
                        ...
                        <div class="testimonial_card_text_content">
                            <p>"A home away from home! Location, room decor, service, tasty local food and staff's
                                friendliness..."</p>
                            <button class="read_more_btn" data-author="Maria Goretti"
                                data-avatar="https://flagcdn.com/w160/no.png" data-location="Norway"
                ...
                <div class="testimonial_card_item box_shadow_hover">
                    ...
                    <div class="testimonial_card_details">
                        ...
                        <div class="testimonial_card_text_content">
                            <p>"Great location near public transportation. The location made it easy for me to visit
                                nearby attractions..."</p>
                            <button class="read_more_btn" data-author="Peter Heinz"
                                data-avatar="https://flagcdn.com/w160/us.png" data-location="United States"
                ...
                <div class="testimonial_card_item box_shadow_hover">
                    ...
                    <div class="testimonial_card_details">
                        ...
                        <div class="testimonial_card_text_content">
                            <p>"Peaceful Oasis in Moshi. We loved this relaxing Oasis and stayed here the night before
                                and after our Kili adventure..."</p>
                            <button class="read_more_btn" data-author="Katie"
                                data-avatar="https://flagcdn.com/w160/us.png" data-location="United States"
                ...
                <div class="testimonial_card_item box_shadow_hover">
                    ...
                    <div class="testimonial_card_details">
                        ...
                        <div class="testimonial_card_text_content">
                            <p>"A comfortable and welcoming place to spend a few days in Moshi. The staff are incredibly
                                helpful, kind and warm..."</p>
                            <button class="read_more_btn" data-author="Jonathan"
                                data-avatar="https://flagcdn.com/w160/be.png" data-location="Belgium"
                ...
                <div class="testimonial_card_item box_shadow_hover">
                    ...
                    <div class="testimonial_card_details">
                        ...
                        <div class="testimonial_card_text_content">
                            <p>"A really good boutique hotel with REALLY good beds and pillows. The swimming pool was
                                lovely!..."</p>
                            <button class="read_more_btn" data-author="Saara"
                                data-avatar="https://flagcdn.com/w160/fi.png" data-location="Finland"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content" style="border-radius: 15px; border: none; overflow: hidden;">
                <div class="modal-header"
                    style="background: #f8f9fa; border-bottom: 1px solid #eee; padding: 15px 25px;">
                ...
                <div class="modal-body" style="padding: 30px;">
                    <div class="text-center mb-4">
                        <div
                            style="width: 80px; height: 80px; border-radius: 50%; border: 3px solid #e77a3a; padding: 2px; margin: 0 auto 15px; overflow: hidden;">
                            <img id="modalAvatar" src="" alt="Guest"
                                style="width: 100%; height: 100%; object-fit: cover; border-radius: 50%;">
                        </div>
                        <h4 id="modalAuthor" style="font-weight: 700; margin-bottom: 5px;"></h4>
                        <p id="modalLocation"
                            style="color: #777; font-size: 13px; text-transform: uppercase; letter-spacing: 1px;"></p>
                    ...
                    <div
                        style="background: #fffaf7; padding: 20px; border-radius: 10px; border-left: 4px solid #e77a3a;">
                        <i class="fa fa-quote-left"
                            style="color: #e77a3a; opacity: 0.3; font-size: 20px; display: block; margin-bottom: 10px;"></i>
                        <p id="modalText"
                            style="font-size: 16px; line-height: 1.8; color: #444; font-style: italic; margin: 0;"></p>
                    </div>
                    <div class="text-center mt-4">
                        <span style="font-size: 12px; color: #999;"><i class="fa fa-google"
                                style="color: #4285F4; margin-right: 5px;"></i> Verified Google Review</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="gallery_slider owl-carousel" style="width: 100%; margin: 0; padding: 0;">
            <div class="gallery_item" style="display: block;">
                <div class="gallery_img"
                    style="position: relative; overflow: hidden; width: 100%; height: 300px; display: block;">
                    <img class="img-fluid" src="{{ asset('hotel_gallery/coffee_.jpg') }}" alt="Hotel Coffee Area"
            ...
            <div class="gallery_item" style="display: block;">
                <div class="gallery_img"
                    style="position: relative; overflow: hidden; width: 100%; height: 300px; display: block;">
                    <img class="img-fluid" src="{{ asset('hotel_gallery/night view_(1).jpg') }}" alt="Hotel Night View"
                        style="width: 100%; height: 100%; object-fit: cover; display: block;"
                        onerror="this.style.display='none';">
                    <div class="hover">
                        <i class="lnr lnr-frame-expand"></i>
            ...
            <div class="gallery_item" style="display: block;">
                <div class="gallery_img"
                    style="position: relative; overflow: hidden; width: 100%; height: 300px; display: block;">
                    <img class="img-fluid" src="{{ asset('hotel_gallery/reception_.jpg') }}" alt="Hotel Reception"
                        style="width: 100%; height: 100%; object-fit: cover; display: block;"
                        onerror="this.style.display='none';">
                    <div class="hover">
                        <i class="lnr lnr-frame-expand"></i>
            ...
            <div class="gallery_item" style="display: block;">
                <div class="gallery_img"
                    style="position: relative; overflow: hidden; width: 100%; height: 300px; display: block;">
                    <img class="img-fluid" src="{{ asset('hotel_gallery/room_.jpg') }}" alt="Hotel Room"
                        style="width: 100%; height: 100%; object-fit: cover; display: block;"
                        onerror="this.style.display='none';">
                    <div class="hover">
                        <i class="lnr lnr-frame-expand"></i>
            ...
            <div class="gallery_item" style="display: block;">
                <div class="gallery_img"
                    style="position: relative; overflow: hidden; width: 100%; height: 300px; display: block;">
                    <img class="img-fluid" src="{{ asset('hotel_gallery/room_(3).jpg') }}" alt="Hotel Room 3"
                        style="width: 100%; height: 100%; object-fit: cover; display: block;"
                        onerror="this.style.display='none';">
                    <div class="hover">
                        <i class="lnr lnr-frame-expand"></i>
            ...
            <div class="gallery_item" style="display: block;">
                <div class="gallery_img"
                    style="position: relative; overflow: hidden; width: 100%; height: 300px; display: block;">
                    <img class="img-fluid" src="{{ asset('hotel_gallery/room_(4).jpg') }}" alt="Hotel Room 4"
                        style="width: 100%; height: 100%; object-fit: cover; display: block;"
                        onerror="this.style.display='none';">
                    <div class="hover">
                        <i class="lnr lnr-frame-expand"></i>
            ...
            <div class="gallery_item" style="display: block;">
                <div class="gallery_img"
                    style="position: relative; overflow: hidden; width: 100%; height: 300px; display: block;">
                    <img class="img-fluid" src="{{ asset('hotel_gallery/room_(5).jpg') }}" alt="Hotel Room 5"
                        style="width: 100%; height: 100%; object-fit: cover; display: block;"
                        onerror="this.style.display='none';">
                    <div class="hover">
                        <i class="lnr lnr-frame-expand"></i>
            ...
            <div class="gallery_item" style="display: block;">
                <div class="gallery_img"
                    style="position: relative; overflow: hidden; width: 100%; height: 300px; display: block;">
                    <img class="img-fluid" src="{{ asset('hotel_gallery/room_(6).jpg') }}" alt="Hotel Room 6"
                        style="width: 100%; height: 100%; object-fit: cover; display: block;"
                        onerror="this.style.display='none';">
                    <div class="hover">
                        <i class="lnr lnr-frame-expand"></i>
            ...
            <div class="gallery_item" style="display: block;">
                <div class="gallery_img"
                    style="position: relative; overflow: hidden; width: 100%; height: 300px; display: block;">
                    <img class="img-fluid" src="{{ asset('hotel_gallery/room_(7).jpg') }}" alt="Hotel Room 7"
                        style="width: 100%; height: 100%; object-fit: cover; display: block;"
                        onerror="this.style.display='none';">
                    <div class="hover">
                        <i class="lnr lnr-frame-expand"></i>
            ...
            <div class="gallery_item" style="display: block;">
                <div class="gallery_img"
                    style="position: relative; overflow: hidden; width: 100%; height: 300px; display: block;">
                    <img class="img-fluid" src="{{ asset('hotel_gallery/swimming floating tray_.jpg') }}"
                        alt="Swimming Pool with Floating Tray"
                        style="width: 100%; height: 100%; object-fit: cover; display: block;"
                        onerror="this.style.display='none';">
                    <div class="hover">
                        <i class="lnr lnr-frame-expand"></i>
            ...
            <div class="gallery_item" style="display: block;">
                <div class="gallery_img"
                    style="position: relative; overflow: hidden; width: 100%; height: 300px; display: block;">
                    <img class="img-fluid" src="{{ asset('hotel_gallery/swimming view_(1).jpg') }}"
                        alt="Swimming Pool View 1" style="width: 100%; height: 100%; object-fit: cover; display: block;"
                        onerror="this.style.display='none';">
                    <div class="hover">
                        <i class="lnr lnr-frame-expand"></i>
                    </div>
            ...
            <div class="gallery_item" style="display: block;">
                <div class="gallery_img"
                    style="position: relative; overflow: hidden; width: 100%; height: 300px; display: block;">
                    <img class="img-fluid" src="{{ asset('hotel_gallery/swimming view_(2).jpg') }}"
                        alt="Swimming Pool View 2" style="width: 100%; height: 100%; object-fit: cover; display: block;"
                        onerror="this.style.display='none';">
                    <div class="hover">
                        <i class="lnr lnr-frame-expand"></i>
                    </div>
