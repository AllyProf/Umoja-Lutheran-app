    ...
    <style>
        ...
        screen and (max-device-width: 767px) {
            ...
            .book_tabel_item .input-group .form-control {
                ...
                max-width: none !important;
                /* Remove max-width constraint in flex */
            }
...
<body>
    ...
    <section class="breadcrumb_area" style="padding: 250px 0px 120px; min-height: 500px; position: relative;">
        <div class="overlay bg-parallax" data-stellar-ratio="0.8" data-stellar-vertical-offset="0" data-background=""
            style="background-image: url('{{ asset('hotel_gallery/room_.jpg') }}'); background-size: cover; background-position: center center; opacity: 1 !important;">
        </div>
        <div
            style="position: absolute; top: 0; left: 0; right: 0; bottom: 0; background: rgba(0, 0, 0, 0.25); z-index: 0;">
        </div>
        <div class="container" style="position: relative; z-index: 1;">
            <div class="page-cover text-center">
                <h2 class="page-cover-tittle" style="color: #e77a3a;">Book Your Room</h2>
                <p style="color: white; font-size: 16px; margin-top: 15px; margin-bottom: 20px;">Reserve your perfect
                    stay at {{ config('app.name') }}</p>
                <ol class="breadcrumb">
                                    ...
                                    <div class="book_tabel_item">
                                        <div class="input-group">
                                            <select class="wide" name="room_type" id="room_type">
                                                ...
                                                <option value="Self-Contained Single" {{ isset($initial_room_type) && $initial_room_type == 'Self-Contained Single' ? 'selected' : '' }}>
                                                    Self-Contained Single</option>
                                                <option value="Self-Contained Double" {{ isset($initial_room_type) && $initial_room_type == 'Self-Contained Double' ? 'selected' : '' }}>
                                                    Self-Contained Double</option>
                                                <option value="Standard Single" {{ isset($initial_room_type) && $initial_room_type == 'Standard Single' ? 'selected' : '' }}>Standard
                                                    Single</option>
                                                <option value="Standard Double" {{ isset($initial_room_type) && $initial_room_type == 'Standard Double' ? 'selected' : '' }}>Standard
                                                    Double</option>
                                                <option value="Standard Triple" {{ isset($initial_room_type) && $initial_room_type == 'Standard Triple' ? 'selected' : '' }}>Standard
                                                    Triple</option>
                                                <option value="Standard Decker" {{ isset($initial_room_type) && $initial_room_type == 'Standard Decker' ? 'selected' : '' }}>Standard
                                                    Decker</option>
                                                <option value="En-suite Single" {{ isset($initial_room_type) && $initial_room_type == 'En-suite Single' ? 'selected' : '' }}>En-suite
                                                    Single</option>
                                                <option value="En-suite Triple" {{ isset($initial_room_type) && $initial_room_type == 'En-suite Triple' ? 'selected' : '' }}>En-suite
                                                    Triple</option>
                                                <option value="En-suite Quad" {{ isset($initial_room_type) && $initial_room_type == 'En-suite Quad' ? 'selected' : '' }}>En-suite
                                                    Quad</option>
                                                <option value="En-suite Quint" {{ isset($initial_room_type) && $initial_room_type == 'En-suite Quint' ? 'selected' : '' }}>En-suite
                                                    Quint</option>
                                                ...
                                                <option value="Twins" {{ isset($initial_room_type) && $initial_room_type == 'Twins' ? 'selected' : '' }}>Standard Twin Room
                                                </option>
                                            </select>
                                        </div>
                                    </div>
    ...
    <div id="bookingModal" class="booking-modal">
        <div class="booking-modal-content">
            ...
            <div class="modal-booking-summary">
                ...
                <div class="booking-summary-breakdown" id="bookingSummaryBreakdown"
                    ...
                    <form id="bookingForm">
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="first_name" name="first_name"
                                        ...
                                        oninput="clearFieldError('first_name')">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="last_name" name="last_name"
                                        ...
                                        oninput="clearFieldError('last_name')">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" id="guest_email" name="guest_email"
                                    ...
                                    oninput="clearFieldError('guest_email')">
                                <span class="error-message" id="guest_email_error"></span>
                                <span class="label-hint">Confirmation email goes to this address (This will be your
                                    username)</span>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group" style="width: 100%;">
                                    <div class="alert alert-info"
                                        style="margin: 0; padding: 15px; background-color: #e7f3ff; border: 1px solid #b3d9ff; border-radius: 4px;">
                                        <i class="fa fa-info-circle" style="margin-right: 8px;"></i>
                                        <strong>Account Information:</strong> Your account will be created
                                        automatically. You will receive your login credentials (Username: Email,
                                        Password: First Name in CAPITALS) via email and SMS after booking confirmation.
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-group">
                                ...
                                <div class="country-search-wrapper">
                                    <span id="country_flag_display" class="country-flag-display"
                                        style="display: none;"></span>
                                    <input type="text" id="country_search" class="country-search-input"
                                        placeholder="Search or type country name..." autocomplete="off" required
                            ...
                            <div class="form-group">
                                ...
                                <div class="phone-input-wrapper">
                                    <select id="country_code" name="country_code" class="country-code-select" required
                                        onchange="clearFieldError('guest_phone')">
                                    ...
                                    <input type="tel" id="guest_phone" name="guest_phone" class="phone-number-input"
                                        placeholder="Phone number" required oninput="clearFieldError('guest_phone')">
                                </div>
                            ...
                            <div class="form-group">
                                <div class="arrival-time-section">
                                    <div class="arrival-time-info">
                                        ...
                                        <p><strong>Your room will be ready for check-in between 14:00 and 23:00</strong>
                                        </p>
                                        <p><i class="fa fa-info-circle info-icon"></i> <strong>24-hour front
                                                desk</strong> – Help whenever you need it!</p>
                                    </div>
                        ...
                        <div class="form-section" id="airportPickupSection">
                            <div class="form-section-title">
                                <label style="margin: 0; cursor: pointer;">
                                    <input type="checkbox" id="airport_pickup_required" name="airport_pickup_required"
                            ...
                            <div id="airportPickupFields" style="display: none; margin-top: 15px;">
                                ...
                                <div class="form-row">
                                    <div class="form-group">
                                        ...
                                        <input type="datetime-local" id="arrival_time_pickup"
                                            name="arrival_time_pickup">
                                    </div>
                                    <div class="form-group">
                                        <label for="pickup_passengers">Number of Passengers</label>
                                        <input type="number" id="pickup_passengers" name="pickup_passengers" min="1"
                                            placeholder="1">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <textarea id="luggage_info" name="luggage_info" rows="2"
                                        placeholder="Number of bags, special items, etc."></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="pickup_contact_number">Contact Number for Pickup</label>
                                    <input type="tel" id="pickup_contact_number" name="pickup_contact_number"
                        ...
                        <div class="form-section">
                            <div class="form-group" style="margin-top: 20px; text-align: center;">
                                <label
                                    style="display: inline-flex; align-items: center; justify-content: center; cursor: pointer; font-weight: normal; text-align: center;">
                                    ...
                                    <span>I have read and agree to the <a href="#"
                                            onclick="event.preventDefault(); openTermsModal();"
                                            style="color: #e77a3a; text-decoration: underline;">Terms & Conditions</a>
                                        *</span>
                                </label>
                                <span class="error-message" id="terms_accepted_error"
                                    style="display: block; text-align: center; margin-top: 8px;"></span>
                            </div>
                        </div>
        ...
        <div class="booking-modal-content" style="max-width: 800px;">
            ...
            <div class="modal-content-wrapper" style="padding: 20px;">
                ...
                <div id="roomDetailsImages" style="margin-bottom: 20px;">
                    <img id="roomDetailsMainImage" src="" alt="Room Image"
                ...
                <div style="display: flex; gap: 10px; justify-content: flex-end;">
                    <button onclick="closeRoomDetailsModal()"
                        style="padding: 10px 20px; background: #6c757d; color: white; border: none; border-radius: 4px; cursor: pointer;">Close</button>
                    <button id="roomDetailsBookBtn" onclick="bookFromDetails()"
                        style="padding: 10px 20px; background: #e77a3a; color: white; border: none; border-radius: 4px; cursor: pointer; font-weight: 600;">Book
                        This Room</button>
                </div>
            </div>
        </div>
    ...
    <div id="termsModal" class="terms-modal">
        <div class="terms-modal-content">
            ...
            <div class="terms-modal-body">
                ...
                <p><strong>All bookings will be confirmed by receiving 50% deposit before guests check in, remaining
                        balance to be cleared on arrival.</strong></p>
                <p>If payment is not received on time, {{ config('app.name') }} reserves the right to collect cash from
                    your guests.</p>
                <ul>
                    <li><strong>Full pre-payment required:</strong> Not later than 30 days prior to guests' arrival.
                    </li>
                    <li><strong>For bookings within 20 days of arrival:</strong> Full pre-payment (i.e., 50% of the
                        total booking amount) will be required within 48 hours of booking time.</li>
                </ul>

                <h3>2. Cancellation Policy</h3>
                <p><strong>All cancellations must be received with written confirmation.</strong></p>
                <ul>
                    <li><strong>Free cancellation:</strong> Clients may cancel their booking free of charges 14 days
                        prior to arrival date.</li>
                    <li><strong>50% cancellation fee:</strong> Cancellations made within 13 days to 3 days (72 hours) of
                        guest arrival date are subject to a cancellation fee of 50% of total deposit.</li>
                    <li><strong>100% cancellation fee:</strong> Cancellations made within 2 days (48 hours) prior to
                        guests' arrival date and no show are subject to a 100% of total deposit.</li>
                </ul>

                <h3>3. Check-in and Check-out</h3>
                <p>Check-in time is from 16:00 (4:00 PM). Check-out time is before 16:00 (4:00 PM). Early check-in and
                    late check-out may be available upon request and subject to availability.</p>

                <h3>4. Guest Responsibilities</h3>
                <p>Guests are responsible for any damage to hotel property. Smoking is prohibited in all rooms. Pets are
                    only allowed in designated pet-friendly rooms.</p>

                <h3>5. Hotel Policies</h3>
                <p>The hotel reserves the right to refuse service to anyone. Guests must provide valid identification
                    upon check-in. The hotel is not responsible for personal belongings left in rooms.</p>

                <h3>6. Force Majeure</h3>
                <p>The hotel is not liable for any failure to perform due to unforeseen circumstances or causes beyond
                    our reasonable control.</p>

                <h3>7. Privacy Policy</h3>
                <p>Your personal information will be used solely for booking purposes and will not be shared with third
