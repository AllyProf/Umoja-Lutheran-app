    function receiveTransfer(transferId) {
      swal({
        ...
        if (isConfirm) {
          callApi(`http://localhost/bar-keeper/transfers/:id/receive`.replace(':id', transferId), 'PUT', { status: 'completed' });
        }
      });
    }
    ...
    function completeOrder(orderId, paymentMethod = 'room_charge') {
      ...
      swal({
        ...
        if (isConfirm) {
          callApi(`http://localhost/bar-keeper/orders/:id/complete`.replace(':id', orderId), 'POST', { payment_method: paymentMethod });
        }
      });
    }
    ...
    const foodBasesData = {"Wali":[{"id":7,"name":"Wali  nyama","side":"Nyama","price":7000,"image":"menu\/jcXpEjhKNF2ODyg6XSvXpPStJ5S1N2rQ54ZkVTl6.jpg"},{"id":8,"name":"wali kuku","side":"Kuku","price":9000,"image":"menu\/z3eSjAySmuXj82VUbwTSbIaRYKu1rn2F7jbTmtSI.jpg"},{"id":9,"name":"wali samaki","side":"Samaki","price":15000,"image":"menu\/OtYrjPhdzdXBVZ3Jqpygz0UlA2QFVMMI7aygUmFo.jpg"},{"id":12,"name":"wali kuku kienyeji","side":"Kuku Kienyeji","price":12000,"image":"menu\/imO7Tp4mNtnVmmuQmfREObgGT3W0krmHHHtyTR7l.jpg"},{"id":14,"name":"wali mboga za majani","side":"Mboga Za Majani","price":4000,"image":"menu\/hXPlDhm46SvA3haVoNX2ORcw2cd0CACVrgKF3PK1.jpg"}],"Ugali":[{"id":11,"name":"ugali kuku","side":"Kuku","price":9000,"image":"menu\/crSHBJRZmMXDHAIGdLFnmEYnIA0grfRMOLAkKS7P.jpg"},{"id":13,"name":"ugali nyama","side":"Nyama","price":7000,"image":"menu\/BotWMGM1JgnDHuyzmstwMEp88qWVm0AfcWhOq8ty.jpg"},{"id":17,"name":"ugali samaki","side":"Samaki","price":15000,"image":"menu\/2swpoDbfrgaE3S8UXKv7Be9dxKqG0teI3sx5CZqW.jpg"},{"id":20,"name":"ugali vegetable","side":"Vegetable","price":4000,"image":"menu\/iGKlNynVwEHpJ8SsO4mYXY7z44lGFttRhiCriyS2.jpg"},{"id":28,"name":"ugali kuku kienyeji","side":"Kuku Kienyeji","price":12000,"image":"menu\/CVYRHXtQA3eLCoHwPWNibMhcDv4EwWtR1Hr5EWte.jpg"}],"Pilau":[{"id":22,"name":"pilau nyama","side":"Nyama","price":7000,"image":"menu\/yXgJsJMq86PKpV98n0j8MYxcd9XR3VcFZQ5np5qW.jpg"},{"id":23,"name":"pilau kuku","side":"Kuku","price":9000,"image":"menu\/2qWtvnnGEGd92xkGpll29SluzW4zxhkgBFI85qse.jpg"},{"id":24,"name":"pilau samaki","side":"Samaki","price":15000,"image":"menu\/OZjCtxuoGo5Z0v03EyKVHYE7XRx9AvsjYuyLctG3.jpg"},{"id":25,"name":"pilau kuku kienyeji","side":"Kuku Kienyeji","price":12000,"image":"menu\/Bve1V86f8sbwzeDMguUkpYwIcKldZ3LeMkmtdUkC.jpg"},{"id":27,"name":"pilau vegetable","side":"Vegetable","price":4000,"image":"menu\/jlKOsCVd7czJHI38Dg2fNUxwk8C6dJ9kXK8JxyLu.jpg"}],"Chapati":[{"id":44,"name":"chapati","side":"Kavu (Plain)","price":1000,"image":"menu\/bEbwQ3FlRXiiFB8Czf2lphDdZ5v8zAUyxOXIl2fv.jpg"}]};
    ...
    async function processWalkInCheckout() {
      ...
      for (const item of posCart) {
        ...
        try {
          const response = await fetch("http://localhost/customer/services/request", {
            method: 'POST',
            headers: {
